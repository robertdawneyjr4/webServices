 ...
 * 
 */
@WebServiceClient(name = "Login", targetNamespace = "http://WS/", wsdlLocation = "http://localhost:8080/AgenciaVuelos/Login?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGIN_QNAME = new QName("http://WS/", "Login");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/AgenciaVuelos/Login?wsdl");
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://WS/", "LoginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WS/", "LoginPort"), Login.class, features);
    }
